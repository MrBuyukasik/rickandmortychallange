...
import com.obss.rickandmorty.databinding.CharacterListItemBinding
...
class AdapterListCharacters(
    private val characters: ArrayList<CharacterObjectModel>,
    private val iCharacters: ICharacters
) :
    DataBoundAdapter<CharacterListItemBinding>(R.layout.character_list_item) {
    lateinit var characterIds: ArrayList<Int>

    override fun bindItem(
        holder: DataBoundViewHolder<CharacterListItemBinding>,
        position: Int,
        payloads: List<Any>
    ) {
